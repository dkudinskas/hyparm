...
void initProtectionMechanism()
{
  ...
  pmrt->pmErrorClearSingle   = 0;
  pmrt->pmErrorClearMulti    = 0;

  pmrt->pmReqInfoPermission0 = 0xFFFF;
  pmrt->pmReqInfoPermission1 = 0;
  ...
  pmgpmc->pmErrorClearSingle   = 0;
  pmgpmc->pmErrorClearMulti    = 0;

  pmgpmc->pmReqInfoPermission0 = 0;
  pmgpmc->pmReqInfoPermission1 = 0;
  pmgpmc->pmReqInfoPermission2 = 0;
  ...
  pmgpmc->pmAddrMatch2         = 0;
  pmgpmc->pmAddrMatch3         = 0;
  pmgpmc->pmAddrMatch4         = 0;
  pmgpmc->pmAddrMatch5         = 0;
  pmgpmc->pmAddrMatch6         = 0;
  pmgpmc->pmAddrMatch7         = 0;
  ...
  {
    memset((void*)pmocmram, 0x0, sizeof(struct PmOcmRam));
    DEBUG(VP_OMAP_35XX_PM, "initProtectionMechanism: @ %p" EOL, pmocmram);
  }

  pmocmram->pmErrorLog           = 0;
  pmocmram->pmControl            = 0x03000000;
  pmocmram->pmErrorClearSingle   = 0;
  pmocmram->pmErrorClearMulti    = 0;

  pmocmram->pmReqInfoPermission0 = 0;
  ...
  pmocmram->pmAddrMatch1         = 0;
  pmocmram->pmAddrMatch2         = 0xF810;
  pmocmram->pmAddrMatch3         = 0;
  pmocmram->pmAddrMatch4         = 0;
  pmocmram->pmAddrMatch5         = 0;
  pmocmram->pmAddrMatch6         = 0;
  pmocmram->pmAddrMatch7         = 0;
  ...
  {
    memset((void*)pmocmrom, 0x0, sizeof(struct PmOcmRom));
    DEBUG(VP_OMAP_35XX_PM, "initProtectionMechanism: @ %p" EOL, pmocmrom);
  }

  pmocmrom->pmErrorLog           = 0;
  pmocmrom->pmControl            = 0x03000000;
  pmocmrom->pmErrorClearSingle   = 0;
  pmocmrom->pmErrorClearMulti    = 0;

  pmocmrom->pmReqInfoPermission0 = 0;
  ...
  // ROM is read-only
  pmocmrom->pmWritePermission0   = 0;
  pmocmrom->pmWritePermission1   = 0;
  ...
  {
    memset((void*)pmiva, 0x0, sizeof(struct PmIva));
    DEBUG(VP_OMAP_35XX_PM, "initProtectionMechanism: @ %p" EOL, pmiva);
  }

  pmiva->pmErrorLog           = 0;
  pmiva->pmControl            = 0x03000000;
  pmiva->pmErrorClearSingle   = 0;
  pmiva->pmErrorClearMulti    = 0;

  pmiva->pmReqInfoPermission0 = 0;
  ...
  pmiva->pmAddrMatch1         = 0;
  pmiva->pmAddrMatch2         = 0;
  pmiva->pmAddrMatch3         = 0;
}

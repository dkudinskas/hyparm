...
#define INTCPS_SYSSTATUS_SOFTRESET      0x00000002 // [0] 0: resetting 1: reset done 
...
#define INTCPS_ILRm_RESERVED            0xFFFFFF02 // [31:8]&[1] reserved
#define INTCPS_ILRm_PRIORITY            0x000000FC // [7:2] interrupt priority
#define INTCPS_ILRm_FIQIRQ              0x00000001 // [0] 0: routed to IRQ 1: routed to FIQ 


// INTC registers that need to be programmed during initialization to ensure optimal power savings
#define ITC_INIT      0x480c7000

#define INTC_INIT_REGISTER1      0x00000010 // RW enables lowest power optimisations
#define INTC_INIT_REGISTER1_RESERVED    0xFFFFFFFE // [31:1] reserved
#define INTC_INIT_REGISTER1_INIT1       0x00000001 // [0] set to 1 during init to ensure lowest power configuration

#define INTC_INIT_REGISTER2      0x00000050 // RW enables optimal power optimisations 
#define INTC_INIT_REGISTER2_RESERVED    0xFFFFFFFD // [31:2]&[0] reserved
#define INTC_INIT_REGISTER2_INIT2       0x00000002 // [1] set to 1 during init to ensure optimal power configuration

...
static struct decodingTableEntry armDataProcMiscInstructions_op0[] =
{
  ...
  ENTRY(IRC_SAFE,    armAndInstruction,         standardImmRegRSR,      0x00000000, 0x0fe00010, "AND Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armEorInstruction,         standardImmRegRSR,      0x00200000, 0x0fe00010, "EOR Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armSubInstruction,         standardImmRegRSR,      0x00400000, 0x0fe00010, "SUB Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armRsbInstruction,         standardImmRegRSR,      0x00600000, 0x0fe00010, "RSB Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armAddInstruction,         standardImmRegRSR,      0x00800000, 0x0fe00010, "ADD Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armAdcInstruction,         standardImmRegRSR,      0x00a00000, 0x0fe00010, "ADC Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armSbcInstruction,         standardImmRegRSR,      0x00c00000, 0x0fe00010, "SBC Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armRscInstruction,         standardImmRegRSR,      0x00e00000, 0x0fe00010, "RSC Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armTstInstruction,         standardImmRegRSRNoDest,0x01000000, 0x0fe00010, "TST Rn, Rm, #shamt"),
  ENTRY(IRC_SAFE,    armTstInstruction,         NULL,                   0x01000010, 0x0fe00090, "TST Rn, Rm, Rshift"),
  // TEQ instructions are all fine
  ENTRY(IRC_SAFE,    armTeqInstruction,         standardImmRegRSRNoDest,0x01200000, 0x0fe00010, "TEQ Rn, Rm, #shamt"),
  ENTRY(IRC_SAFE,    armTeqInstruction,         NULL,                   0x01200010, 0x0fe00090, "TEQ Rn, Rm, Rshift"),
  // CMP instructions are all fine
  ENTRY(IRC_SAFE,    armCmpInstruction,         standardImmRegRSRNoDest,0x01400000, 0x0fe00010, "CMP Rn, Rm, #shamt"),
  ENTRY(IRC_SAFE,    armCmpInstruction,         NULL,                   0x01400010, 0x0fe00090, "CMP Rn, Rm, Rshamt"),
  // CMN instructions are all fine
  ENTRY(IRC_SAFE,    armCmnInstruction,         standardImmRegRSRNoDest,0x01600000, 0x0fe00010, "CMN Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armOrrInstruction,         standardImmRegRSR,      0x01800000, 0x0fe00010, "ORR Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armLslInstruction,         armLslrPCInstruction,   0x01a00000, 0x0fef0070, "LSL Rd, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armLsrInstruction,         armLslrPCInstruction,   0x01a00020, 0x0fef0070, "LSR Rd, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armAsrInstruction,         armAsrPCInstruction,    0x01a00040, 0x0fef0070, "ASR Rd, Rm, #shamt"),
  ...
  ENTRY(IRC_SAFE,    armRrxInstruction,         armRrxPCInstruction,    0x01a00060, 0x0fef0ff0, "RRX Rd, Rm"),
  ...
  ENTRY(IRC_SAFE,    armRorInstruction,         armRorPCInstruction,    0x01a00060, 0x0fef0070, "ROR Rd, Rm, #imm"),
  ...
  ENTRY(IRC_SAFE,    armBicInstruction,         standardImmRegRSR,      0x01c00000, 0x0fe00010, "BIC Rd, Rn, Rm, #shamt"),
...
static struct decodingTableEntry armDataProcMiscInstructions_op1[] =
{
  ...
  ENTRY(IRC_SAFE,    armAndInstruction,         standardImmRegRSR,      0x02000000, 0x0fe00000, "AND Rd, Rn, #imm"),
  // EOR: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armEorInstruction,         NULL,                   0x0220f000, 0x0fe0f000, "EOR PC, Rn, Rm/#imm"),
  ENTRY(IRC_SAFE,    armEorInstruction,         standardImmRegRSR,      0x02200000, 0x0fe00000, "EOR Rd, Rn, #imm"),
  // SUB: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armSubInstruction,         NULL,                   0x0240f000, 0x0fe0f000, "SUB PC, Rn, Rm/imm"),
  ENTRY(IRC_SAFE,    armSubInstruction,         standardImmRegRSR,      0x02400000, 0x0fe00000, "SUB Rd, Rn, #imm"),
  // RSB: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armRsbInstruction,         NULL,                   0x0260f000, 0x0fe0f000, "RSB PC, Rn, Rm/imm"),
  ENTRY(IRC_SAFE,    armRsbInstruction,         standardImmRegRSR,      0x02600000, 0x0fe00000, "RSB Rd, Rn, #imm"),
  // ADD: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armAddInstruction,         NULL,                   0x0280f000, 0x0fe0f000, "ADD PC, Rn, #imm"),
  ENTRY(IRC_SAFE,    armAddInstruction,         standardImmRegRSR,      0x02800000, 0x0fe00000, "ADD Rd, Rn, #imm"),
  // ADC: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armAdcInstruction,         NULL,                   0x02a0f000, 0x0fe0f000, "ADC PC, Rn/#imm"),
  ENTRY(IRC_SAFE,    armAdcInstruction,         standardImmRegRSR,      0x02a00000, 0x0fe00000, "ADC Rd, Rn, #imm"),
  // SBC: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armSbcInstruction,         NULL,                   0x02c0f000, 0x0fe0f000, "SBC PC, Rn/#imm"),
  ENTRY(IRC_SAFE,    armSbcInstruction,         standardImmRegRSR,      0x02c00000, 0x0fe00000, "SBC Rd, Rn, #imm"),
  // RSC: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armRscInstruction,         NULL,                   0x02e0f000, 0x0fe0f000, "RSC PC, Rn/#imm"),
  ENTRY(IRC_SAFE,    armRscInstruction,         standardImmRegRSR,      0x02e00000, 0x0fe00000, "RSC Rd, Rn, #imm"),
  ...
  // TST instructions are all fine
  ENTRY(IRC_SAFE,    armTstInstruction,         standardImmRegRSRNoDest,0x03000000, 0x0fe00000, "TST Rn, #imm"),
  // TEQ instructions are all fine
  ENTRY(IRC_SAFE,    armTeqInstruction,         standardImmRegRSRNoDest,0x03200000, 0x0fe00000, "TEQ Rn, #imm"),
  // CMP instructions are all fine
  ENTRY(IRC_SAFE,    armCmpInstruction,         standardImmRegRSRNoDest,0x03400000, 0x0fe00000, "CMP Rn, #imm"),
  // CMN instructions are all fine
  ENTRY(IRC_SAFE,    armCmnInstruction,         standardImmRegRSRNoDest,0x03600000, 0x0fe00000, "CMN Rn, #imm"),
  // ORR: Rd = PC end block, other are fine
...
{
  // STRT - all trap
  ENTRY(IRC_LS_USER, armStrtInstruction,         NULL,                  0x04200000, 0x0f700000, "STRT Rt, [Rn], +-imm12"),
  ENTRY(IRC_LS_USER, armStrtInstruction,         NULL,                  0x06200000, 0x0f700010, "STRT Rt, [Rn], +-Rm"),
  // LDRT - all trap
  ENTRY(IRC_LS_USER, armLdrtInstruction,         NULL,                  0x04300000, 0x0f700000, "LDRT Rd, [Rn], +-imm12"),
  ENTRY(IRC_LS_USER, armLdrtInstruction,         NULL,                  0x06300000, 0x0f700010, "LDRT Rd, [Rn], +-Rm"),
  // STRBT - all trap
  ENTRY(IRC_LS_USER, armStrbtInstruction,        NULL,                  0x04600000, 0x0f700000, "STRBT Rt, [Rn, +-imm12]"),
  ENTRY(IRC_LS_USER, armStrbtInstruction,        NULL,                  0x06600000, 0x0f700010, "STRBT Rt, [Rn], +-Rm"),
  // LDRBT - all trap

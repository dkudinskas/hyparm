...
static struct decodingTableEntry armDataProcMiscInstructions_op1[] =
{
  ...
  { IRC_REPLACE,  &undefinedInstruction, 0x00000000, 0x00000000, "armDataProcMiscInstructions_op1" }
};
...
static struct decodingTableEntry armLoadStoreWordByteInstructions[] =
{
  ...
  { IRC_REPLACE,  &undefinedInstruction, 0x00000000, 0x00000000, "armLoadStoreWordByteInstructions" }
};
...
static struct decodingTableEntry armMediaInstructions[] =
{
  ...
  { IRC_REPLACE,  undefinedInstruction, 0x00000000, 0x00000000, "armMediaInstructions" }
};
...
static struct decodingTableEntry armSvcCoprocInstructions[] =
{
  ...
  { IRC_REPLACE,  undefinedInstruction,    0x00000000, 0x00000000, "armSvcCoprocInstructions" }
};

...
static struct decodingTableEntry armDataProcMiscInstructions_op0[] =
{
  ...
  ENTRY(IRC_PATCH_PC,armLdrdInstruction,        armLdrdhPCInstruction,  0x004000d0, 0x0e5000f0, "LDRD Rt, [Rn, #imm]"),
  ENTRY(IRC_PATCH_PC,armLdrdInstruction,        armLdrdhPCInstruction,  0x000000d0, 0x0e500ff0, "LDRD Rt, [Rn, Rm]"),
  // STRD: pass through, let them fail!
  ENTRY(IRC_PATCH_PC,    armStrdInstruction,        armStrPCInstruction,    0x004000f0, 0x0e5000f0, "STRD Rt, [Rn, #imm]"),
  ENTRY(IRC_PATCH_PC,    armStrdInstruction,        armStrPCInstruction,    0x000000f0, 0x0e500ff0, "STRD Rt, [Rn, Rm]"),
  ...
  ENTRY(IRC_PATCH_PC,    armStrhInstruction,        armStrPCInstruction,    0x004000b0, 0x0e5000f0, "STRH Rt, [Rn, +-imm8]"),
  ENTRY(IRC_PATCH_PC,    armStrhInstruction,        armStrPCInstruction,    0x000000b0, 0x0e500ff0, "STRH Rt, [Rn], +-Rm"),
  // LDRH cant load halfword to PC, passthrough
  ENTRY(IRC_PATCH_PC,    armLdrhInstruction,        armLdrdhPCInstruction,    0x00500090, 0x0e500090, "LDRH Rt, [Rn, +-imm8]"),
  ENTRY(IRC_PATCH_PC,    armLdrhInstruction,        armLdrdhPCInstruction,    0x00100090, 0x0e500f90, "LDRH Rt, [Rn], +-Rm"),
  ...
  ENTRY(IRC_PATCH_PC,    armAndInstruction,         armALUImmRegRSR,         0x00000000, 0x0fe00010, "AND Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armEorInstruction,         armALUImmRegRSR,         0x00200000, 0x0fe00010, "EOR Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armSubInstruction,         armALUImmRegRSR,         0x00400000, 0x0fe00010, "SUB Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armRsbInstruction,         armALUImmRegRSR,         0x00600000, 0x0fe00010, "RSB Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armAddInstruction,         armALUImmRegRSR,         0x00800000, 0x0fe00010, "ADD Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armAdcInstruction,         armALUImmRegRSR,         0x00a00000, 0x0fe00010, "ADC Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armSbcInstruction,         armALUImmRegRSR,         0x00c00000, 0x0fe00010, "SBC Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armRscInstruction,         armALUImmRegRSR,         0x00e00000, 0x0fe00010, "RSC Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armTstInstruction,         armALUImmRegRSRNoDest,   0x01000000, 0x0fe00010, "TST Rn, Rm, #shamt"),
  ENTRY(IRC_SAFE,    armTstInstruction,         NULL,                   0x01000010, 0x0fe00090, "TST Rn, Rm, Rshift"),
  // TEQ instructions are all fine
  ENTRY(IRC_PATCH_PC,    armTeqInstruction,         armALUImmRegRSRNoDest,   0x01200000, 0x0fe00010, "TEQ Rn, Rm, #shamt"),
  ENTRY(IRC_SAFE,    armTeqInstruction,         NULL,                   0x01200010, 0x0fe00090, "TEQ Rn, Rm, Rshift"),
  // CMP instructions are all fine
  ENTRY(IRC_PATCH_PC,    armCmpInstruction,         armALUImmRegRSRNoDest,   0x01400000, 0x0fe00010, "CMP Rn, Rm, #shamt"),
  ENTRY(IRC_SAFE,    armCmpInstruction,         NULL,                   0x01400010, 0x0fe00090, "CMP Rn, Rm, Rshamt"),
  // CMN instructions are all fine
  ENTRY(IRC_PATCH_PC,    armCmnInstruction,         armALUImmRegRSRNoDest,   0x01600000, 0x0fe00010, "CMN Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armOrrInstruction,         armALUImmRegRSR,         0x01800000, 0x0fe00010, "ORR Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armMovInstruction,         armMovPCInstruction,    0x01a00000, 0x0def0ff0, "MOV Rn, Rm"),
  ...
  ENTRY(IRC_PATCH_PC,    armLslInstruction,         armShiftPCImm,  0x01a00000, 0x0fef0070, "LSL Rd, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armLsrInstruction,         armShiftPCImm,  0x01a00020, 0x0fef0070, "LSR Rd, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armAsrInstruction,         armShiftPCImm,  0x01a00040, 0x0fef0070, "ASR Rd, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armRrxInstruction,         armShiftPCImm,  0x01a00060, 0x0fef0ff0, "RRX Rd, Rm"),
  ...
  ENTRY(IRC_PATCH_PC,    armRorInstruction,         armShiftPCImm,  0x01a00060, 0x0fef0070, "ROR Rd, Rm, #imm"),
  ...
  ENTRY(IRC_PATCH_PC,    armBicInstruction,         armALUImmRegRSR,         0x01c00000, 0x0fe00010, "BIC Rd, Rn, Rm, #shamt"),
  ...
  ENTRY(IRC_PATCH_PC,    armMvnInstruction,         armShiftPCImm,  0x01e00000, 0x0fe00010, "MVN Rd, Rm, #shamt"),
...
static struct decodingTableEntry armDataProcMiscInstructions_op1[] =
{
  ...
  ENTRY(IRC_SAFE,    nopInstruction,            NULL,                   0x0320f000, 0x0fffffff, "NOP"),
  ...
  ENTRY(IRC_PATCH_PC,    armAndInstruction,         armALUImmRegRSR,         0x02000000, 0x0fe00000, "AND Rd, Rn, #imm"),
  // EOR: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armEorInstruction,         NULL,                   0x0220f000, 0x0fe0f000, "EOR PC, Rn, Rm/#imm"),
  ENTRY(IRC_PATCH_PC,    armEorInstruction,         armALUImmRegRSR,         0x02200000, 0x0fe00000, "EOR Rd, Rn, #imm"),
  // SUB: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armSubInstruction,         NULL,                   0x0240f000, 0x0fe0f000, "SUB PC, Rn, Rm/imm"),
  ENTRY(IRC_PATCH_PC,    armSubInstruction,         armALUImmRegRSR,         0x02400000, 0x0fe00000, "SUB Rd, Rn, #imm"),
  // RSB: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armRsbInstruction,         NULL,                   0x0260f000, 0x0fe0f000, "RSB PC, Rn, Rm/imm"),
  ENTRY(IRC_PATCH_PC,    armRsbInstruction,         armALUImmRegRSR,         0x02600000, 0x0fe00000, "RSB Rd, Rn, #imm"),
  // ADD: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armAddInstruction,         NULL,                   0x0280f000, 0x0fe0f000, "ADD PC, Rn, #imm"),
  ENTRY(IRC_PATCH_PC,    armAddInstruction,         armALUImmRegRSR,         0x02800000, 0x0fe00000, "ADD Rd, Rn, #imm"),
  // ADC: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armAdcInstruction,         NULL,                   0x02a0f000, 0x0fe0f000, "ADC PC, Rn/#imm"),
  ENTRY(IRC_PATCH_PC,    armAdcInstruction,         armALUImmRegRSR,         0x02a00000, 0x0fe00000, "ADC Rd, Rn, #imm"),
  // SBC: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armSbcInstruction,         NULL,                   0x02c0f000, 0x0fe0f000, "SBC PC, Rn/#imm"),
  ENTRY(IRC_PATCH_PC,    armSbcInstruction,         armALUImmRegRSR,         0x02c00000, 0x0fe00000, "SBC Rd, Rn, #imm"),
  // RSC: Rd = PC end block, others are fine
  ENTRY(IRC_REPLACE, armRscInstruction,         NULL,                   0x02e0f000, 0x0fe0f000, "RSC PC, Rn/#imm"),
  ENTRY(IRC_PATCH_PC,    armRscInstruction,         armALUImmRegRSR,         0x02e00000, 0x0fe00000, "RSC Rd, Rn, #imm"),
  ...
  // TST instructions are all fine
  ENTRY(IRC_PATCH_PC,    armTstInstruction,         armALUImmRegRSRNoDest,   0x03000000, 0x0fe00000, "TST Rn, #imm"),
  // TEQ instructions are all fine
  ENTRY(IRC_PATCH_PC,    armTeqInstruction,         armALUImmRegRSRNoDest,   0x03200000, 0x0fe00000, "TEQ Rn, #imm"),
  // CMP instructions are all fine
  ENTRY(IRC_PATCH_PC,    armCmpInstruction,         armALUImmRegRSRNoDest,   0x03400000, 0x0fe00000, "CMP Rn, #imm"),
  // CMN instructions are all fine
  ENTRY(IRC_PATCH_PC,    armCmnInstruction,         armALUImmRegRSRNoDest,   0x03600000, 0x0fe00000, "CMN Rn, #imm"),
  // ORR: Rd = PC end block, other are fine
  ENTRY(IRC_REPLACE, armOrrInstruction,         NULL,                   0x0380f000, 0x0fe0f000, "ORR Rd, Rn, #imm"),
  ENTRY(IRC_PATCH_PC,    armOrrInstruction,         armALUImmRegRSR,         0x03800000, 0x0fe00000, "ORR Rd, Rn, #imm"),
  ...
  ENTRY(IRC_PATCH_PC,    armBicInstruction,         armALUImmRegRSR,         0x03c00000, 0x0fe00000, "BIC Rd, Rn, #imm"),
  // MVN with Rd = PC end block, other are fine.
...
static struct decodingTableEntry armLoadStoreWordByteInstructions[] =
{
  ...
  ENTRY(IRC_PATCH_PC,    armLdrInstruction,          armLdrPCInstruction,   0x04100000, 0x0e500000, "LDR Rd, [Rn], +-imm12"),
  ENTRY(IRC_REPLACE,     armLdrInstruction,          NULL,                  0x0610f000, 0x0e50f010, "LDR PC, [Rn], +-Rm"),
  ENTRY(IRC_PATCH_PC,    armLdrInstruction,          armLdrPCInstruction,   0x06100000, 0x0e500010, "LDR Rd, [Rn], +-Rm"),
  // STRB pass through
  ENTRY(IRC_PATCH_PC,    armStrbInstruction,         armStrPCInstruction,   0x04400000, 0x0e500000, "STRB Rt, [Rn, +-imm12]"),
  ENTRY(IRC_PATCH_PC,    armStrbInstruction,         armStrPCInstruction,   0x06400000, 0x0e500010, "STRB Rt, [Rn], +-Rm"),
  // LDRB - pass through, dest can't be PC
  ENTRY(IRC_PATCH_PC,    armLdrbInstruction,         armLdrPCInstruction,   0x04500000, 0x0e500000, "LDRB Rd, [Rn], +-imm12"),
  ENTRY(IRC_PATCH_PC,    armLdrbInstruction,         armLdrPCInstruction,   0x06500000, 0x0e500010, "LDRB Rd, [Rn], +-Rm"),
...
static struct decodingTableEntry armUnconditionalInstructions[] =
{
  ...
  // CLREX: clear exclusive monitor, can be treated as safe.
  ENTRY(IRC_SAFE,    armClrexInstruction,        NULL,                  0xf57ff01f, 0xffffffff, "clrex"),

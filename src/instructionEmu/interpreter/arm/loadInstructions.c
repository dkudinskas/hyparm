...
u32int armLdrexInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_LOAD, "armLdrexInstruction: %#.8x @ %#.8x" EOL, instruction, context->R15);
...
u32int armLdrexbInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_LOAD, "armLdrexbInstruction: %#.8x @ %#.8x" EOL, instruction, context->R15);
...
u32int armLdrexhInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_LOAD, "armLdrexhInstruction: %#.8x @ %#.8x" EOL, instruction, context->R15);
...
u32int armLdrexdInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_LOAD, "armLdrexdInstruction: %#.8x @ %#.8x" EOL, instruction, context->R15);
...
u32int armLdmInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_LOAD, "armLdmInstruction: %#.8x @ %#.8x" EOL, instruction, context->R15);

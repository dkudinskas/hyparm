...
u32int armStrInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_STORE, "armStrInstruction: %#.8x @ %#.8x" EOL, instruction, getRealPC(context));
...
u32int armStrbInstruction(GCONTXT * context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_STORE, "armStrbInstruction: %#.8x @ %#.8x" EOL, instruction, getRealPC(context));
...
u32int armStrhInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_STORE, "armStrhInstruction: %#.8x @ %#.8x" EOL, instruction, getRealPC(context));
...
u32int armStrdInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_STORE, "armStrdInstruction: %#.8x @ %#.8x" EOL, instruction, getRealPC(context));
...
u32int armStrhtInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_STORE, "armStrhtInstruction: %#.8x @ %#.8x" EOL, instruction, getRealPC(context));
...
u32int armStrexInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_STORE, "armStrexInstruction: %#.8x @ %#.8x" EOL, instruction, getRealPC(context));
...
u32int armStmInstruction(GCONTXT *context, u32int instruction)
{
  ...
  DEBUG(INTERPRETER_ARM_STORE, "armStmInstruction: %#.8x @ %#.8x" EOL, instruction, getRealPC(context));

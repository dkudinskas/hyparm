...
//{(u32int)(&dmbInstruction) &1,       0xf57ff050, 0xfffffff0, "dmb\t%U"} => {&dmbInstruction &1,&dmbPCInstruction &1,       0xf57ff050, 0xfffffff0, "dmb\t%U"}
//mv decoder.c decoder.backup && sed 's/^{\(&[a-z]*\)\(Instruction\)[ ,][&1,]*/& \1PC\2,/' <decoder.backup >decoder.c
...
{1, lslInstruction, lslPCInstruction,         0x01a0f020, 0x0feff070, "LSR Rd, Rm, #shamt"},
{1, lsrInstruction, lsrPCInstruction,         0x01a0f030, 0x0feff0f0, "LSR Rd, Rm, Rshamt"},
{0, lslInstruction, lslPCInstruction,         0x01a00020, 0x0fef0070, "LSR Rd, Rm, #shamt"},
...
{1, uxtahInstruction, uxtahPCInstruction,       0x06f00070, 0x0ff00ff0, "uxtah%c\t%12-15r, %16-19r, %0-3r"},
{1, uxtahInstruction, uxtahPCInstruction,       0x06f00470, 0x0ff00ff0, "uxtah%c\t%12-15r, %16-19r, %0-3r, ror #8"},
{1, uxtahInstruction, uxtahPCInstruction,       0x06f00870, 0x0ff00ff0, "uxtah%c\t%12-15r, %16-19r, %0-3r, ror #16"},
{1, uxtahInstruction, uxtahPCInstruction,       0x06f00c70, 0x0ff00ff0, "uxtah%c\t%12-15r, %16-19r, %0-3r, ror #24"},

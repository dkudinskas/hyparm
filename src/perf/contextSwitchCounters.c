...
void registerSvc(GCONTXT *context, InstructionHandler handler)
{
  ...
  else if (handler == armStmUserInstruction)
  {
    context->armStmInstruction++;
  }
  ...
  else if (handler == armLdrRegInstruction)
  {
    context->armLdrInstruction++;
  }
  ...
  else if (handler == armStrbtImmInstruction)
  {
    context->armStrbtInstruction++;
  }
  else if (handler == armStrbtRegInstruction)
  {
    context->armStrbtInstruction++;
  }
  else if (handler == armStrhtImmInstruction)
  {
    context->armStrhtInstruction++;
  }
  else if (handler == armStrhtRegInstruction)
  {
    context->armStrhtInstruction++;
  }
  else if (handler == armStrtImmInstruction)
  {
    context->armStrtInstruction++;
  }
  else if (handler == armStrtRegInstruction)
  {
    context->armStrtInstruction++;
  }
  else if (handler == armLdrbtImmInstruction)
  {
    context->armLdrbtInstruction++;
  }
  else if (handler == armLdrbtRegInstruction)
  {
    context->armLdrbtInstruction++;
  }
  else if (handler == armLdrhtImmInstruction)
  {
    context->armLdrhtInstruction++;
  }
  else if (handler == armLdrhtRegInstruction)
  {
    context->armLdrhtInstruction++;
  }
  else if (handler == armLdrtImmInstruction)
  {
    context->armLdrtInstruction++;
  }
  else if (handler == armLdrtRegInstruction)
  {
    context->armLdrtInstruction++;
  }
  else
